...
import move from "/assets/movewithme.png";
function MyProjects() {
  return (
    <div id="projects">
      <h1>My Projects</h1>
      <div id="content">
        ...
        <div className="project">
          <Link to="https://movewithme-e89w.vercel.app/" target="_blank">
            <h4>Move With Me</h4>
          </Link>
          <Link to="https://movewithme-e89w.vercel.app/" target="_blank">
            <img src={move} className="image" />
          </Link>
          <div id="languages">
            <Link
              to="https://www.youtube.com/@moveWithMe-foryou/shorts"
              target="_blank"
            >
              Youtube
            </Link>
        ...
        <div className="project">
          <Link
            to="https://e-commerce-website-two-drab.vercel.app/"
            target="_blank"
          >
        ...
        <div className="project">
          <Link to="https://githubuser-xi.vercel.app/" target="_blank">
            <h4>Github user search using API</h4>
          </Link>
          <Link to="https://githubuser-xi.vercel.app/" target="_blank">
            <img src={githubuser} className="image" />
          </Link>
        ...
        <div className="project">
          <Link
            to="https://easybanklandingpage-sand.vercel.app/"
            target="_blank"
          >
        ...
        <div className="project">
          ...
          <Link to="https://timetracker-rho-sage.vercel.app/">
            <img src={timetracker} className="image" />
          </Link>
          <div id="languages">
            <label>React</label>
            <label>CSS3</label>
        ...
        <div className="project">
          <Link
            to="https://single-page-portfolio-one.vercel.app/"
            target="_blank"
          >
            <h4>Single Page Portfolio</h4>
          </Link>
          <a
            href="https://single-page-portfolio-one.vercel.app/"
            target="_blank"
          >
        ...
        <div className="project">
          ...
          <Link to="https://joblisting-flax.vercel.app/">
            <img src={joblisting} className="image" />
          </Link>
          <div id="languages">
            <label>React</label>
            <label>CSS3</label>
